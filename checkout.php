          ...
          <nav>
            ...
            >
              ...
              <li>
                <a
                  href="#"
                  class="btn bg-white text-black border border-slate-800 inline-block mr-0.5"
                  >Logout
                </a>
              </li>
            </ul>
    ...
    <main class="-z-10 mt-32">
      <div class="container mx-auto px-8">
        ...
        <div class="grid gap-2">
          ...
          />
          <span class="font-medium mb-5 flex items-center gap-2"
            >Order Total: <span class="text-xl font-bold">$18.3</span></span
          >
          <div>
            <a href="javascript:void(0)" class="btn justify-end">Checkout</a>
          </div>
        </div>
      </div>
    </main>
